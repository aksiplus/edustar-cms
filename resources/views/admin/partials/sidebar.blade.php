<div class="br-sideleft overflow-y-auto">
        ...
        <ul class="br-sideleft-menu">
            <li class="br-menu-item">
                <a href="{{ route('admin.dashboard') }}" class="br-menu-link {{ set_active('admin.dashboard') }}">
            ...
            <label class="sidebar-label pd-x-10 mg-t-10 op-3">Data Pokok</label>
            <li class="br-menu-item">
                <a href="{{ route('admin.tenaga_pendidik') }}" class="br-menu-link {{ set_active('admin.tenaga_pendidik') }}">
                    <i class="menu-item-icon fa fa-users"></i>
                    <span class="menu-item-label">Tenaga Pendidik</span>
                </a><!-- br-menu-link -->
            </li>
            <li class="br-menu-item">
